 ...
 * @version 0.1
 * @date 22-Feb-2022
 * @brief This contains definitions for the Tonic-Clonic Seizure pattern recognition primitive.
 */

#ifndef PDCS_SZ_GTC_H_
#define PDCS_SZ_GTC_H_
...
class sz_gtc_pr {
 public:
  ...
  /**
   * @brief  Initialise the pattern recognition object for gtc seizure patterns.
  ...
  /**
   * @brief   Predict whether the input signal is an gtc seizure pattern or not.
