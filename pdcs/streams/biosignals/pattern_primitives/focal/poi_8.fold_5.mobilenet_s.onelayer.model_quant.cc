unsigned char __results_seizure_binary_onelayer_checkpoint_poi_8_fold_5_mobilenet_s_onelayer_model_quant_int_tflite[] = {
...
unsigned int __results_seizure_binary_onelayer_checkpoint_poi_8_fold_5_mobilenet_s_onelayer_model_quant_int_tflite_len = 5216;
