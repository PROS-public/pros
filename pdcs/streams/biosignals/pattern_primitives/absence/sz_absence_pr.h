/**
 * @file sz_absence_pr.h
 * @author  Nhat Pham <nhat.pham@cs.ox.ac.edu>.
 * @version 0.1
 * @date 22-Feb-2022
 * @brief This contains definitions for the Absence Seizure pattern recognition primitive.
 */

#ifndef PDCS_SZ_ABSENCE_H_
#define PDCS_SZ_ABSENCE_H_
